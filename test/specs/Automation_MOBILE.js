...
describe('Happy - Android Mobile Test', () => {
    ...
    it('Enter all the values to search a reservation', async () => {
        ...
        await $('//android.view.View[@content-desc="17 August 2023"]').click();
        await $('//android.view.View[@content-desc="26 August 2023"]').click();
       ...
       // const location = await $('/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.FrameLayout[1]/android.widget.LinearLayout/androidx.recyclerview.widget.RecyclerView[2]/android.widget.FrameLayout[1]/android.widget.LinearLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.TextView.widget.TextView');
       ...
       await expect(location).toHaveText("Cusco");
        ...
        await expect(date).toHaveText("Thu, Aug 17 - Sat, Aug 26");
